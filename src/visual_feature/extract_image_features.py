...
if __name__ == "__main__":
    ...
    parser.add_argument("--feature_file", type=str, default='./features/feature.hdf5')
    parser.add_argument("--base_dir", type=str, default='./frames')
    parser.add_argument("--feature_type", type=str, default="2048", choices=["2048", "2048x7x7", "c3"])
    ...
    if s.lower() == "y":
        ...
        sub_dirs = [d for d in os.listdir(args.base_dir) if os.path.isdir(os.path.join(args.base_dir, d))] #['BH0Q5HaY-Do_1', 'EOyVu7ZEf50_1', 'u5-4sI3SwpQ_1', 'v5ZUTM4YbTs_2']
